  ...
  return (
    <div className="mx-auto font-Roboto mt-10">
      ...
      <div className="flex items-center justify-between lg:px-12 px-8 ">
        <h3 className="font-semibold text-xl">Aset Lelang</h3>
        <div>
      ...
      <div className="w-full overflow-hidden overflow-x-auto lg:px-12 pl-8 no-scrollbar">
        <div className="mt-4 flex gap-4 w-[1024px] lg:w-full">
          {itemPopular.map((_, index) => (
            <div>
              <div className="items-start gap-4 border border-gray-200 p-2 rounded-md">
                <div className="flex">
